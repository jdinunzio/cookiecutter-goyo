...
def remove_fastapi():
    ...
    paths_to_remove = {
        ...
        test_path: ["unit/infrastructure/server"],
    }
    remove_paths(paths_to_remove)
...
def remove_repository_and_sqlalchemy():
    ...
    paths_to_remove = {
        package_path: [
            ...
            "infrastructure/adapters/factory",
        ],
        test_path: [
            "unit/domain/test_todo.py",
            "unit/domain/test_todolist.py",
            "unit/infrastructure/test_get_factory.py",
            "integration/infrastructure/adapters/alchemy",
            "integration/infrastructure/adapters/factory",
        ],
    }
    remove_paths(paths_to_remove)
